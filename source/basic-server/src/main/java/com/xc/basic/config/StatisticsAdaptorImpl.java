...
import com.xc.basic.entity.StatisticsEntity;
import com.xc.basic.mapper.StatisticsMapper;
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                if (!(throwable instanceof OperateException)) {
                    ...
                    messageService.sendSystemErrorNoticeMessage(appEntity, throwable.getMessage() + "");
                }
            } catch (Exception e) {
